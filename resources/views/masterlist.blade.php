...
@section('content')
    <div class="container">
        <div style="overflow : auto">
                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div class="card-body p-2">
                            ...
                            @else
                                <h6 class="card-subtitle mt-1mt-1"> {{ count(Auth()->user()->section->learners) }}
                                </h6>
                            @endif
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div class="card-body p-2">
                            ...
                            @else
                                <h6 class="card-subtitle mt-1mt-1"> No Section</h6>
                            @endif
            ...
            <div class="card">
                <div class="card-header">
                    <form action="{{ url('search/masterlist') }}" method="GET">
                        @csrf
                        ...
                        <a href="{{ url('masterlist') }}" class="btn btn-primary"><i class="fa fa-refresh"
